/*
	...
	- Task: Use the filter Method to Extract Data from an Array
*/
...
// values are saved as strings in the object and you may need to convert them into \
// numbers to perform mathematical operations on them.
...
var filteredList = (watchList.map( 
	function(item) {
		...
		return parseInt(item["rating"]) >= 8.0; 
});
