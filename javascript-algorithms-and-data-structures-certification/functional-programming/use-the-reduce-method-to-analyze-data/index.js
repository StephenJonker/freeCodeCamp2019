/*
	...
	- Task: Use the reduce Method to Analyze Data
*/
...
function getRating(watchList){
	...
	var averageRating;
	  ...
	  let res = watchList.reduce(
		  function( acc, cur ) {
			  let r = 0;
		if ( cur.Director == "Christopher Nolan") {
				r = parseFloat( cur.imdbRating );
		}
			  return acc + r;
		  },0.0 
	  );
  
	let numOfMatchesForCN = watchList.reduce( (acc, cur) => {
	  let res = acc;
	  if ( cur.Director == "Christopher Nolan" ) {
		res = acc + 1;
	  }
	  ...
	  averageRating = res / numOfMatchesForCN;
  
	// Only change code above this line
	return averageRating;
}

let res = getRating(watchList);

console.log("The value in variable res is: " + res + " Expect 8.675");
